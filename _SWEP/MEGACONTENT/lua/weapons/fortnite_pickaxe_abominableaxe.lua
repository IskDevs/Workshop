/*---------------------------------
FORTNITE ABOMINABLE AXE 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_abominableaxe.lua" )

SWEP.PrintName = "Abominable Axe"
...
SWEP.ViewModel = "models/fortnite/v_fbr_abominableaxe.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_abominableaxe.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_abominableaxe" )
killicon.Add( "fortnite_pickaxe_abominableaxe", "VGUI/hud/fortnite_pickaxe_abominableaxe", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_AbominableAxe.Draw")
...
self:EmitSound("Fortnite_AbominableAxe.Swing_" .. math.random(1, 2) .. "")
self:MeleePickaxe()
end
...
if IsFirstTimePredicted() then
	...
	rocket.PickaxeType = "AbominableAxe"
	rocket:Activate()
...
self:StopSound("Fortnite_AbominableAxe.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_abominableaxe_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
