/*---------------------------------
FORTNITE DIRECTOR'S CUT 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_directorscut.lua" )

SWEP.PrintName = "Director's Cut"
...
SWEP.ViewModel = "models/fortnite/v_fbr_directorscut.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_directorscut.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_directorscut" )
killicon.Add( "fortnite_pickaxe_directorscut", "VGUI/hud/fortnite_pickaxe_directorscut", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_DirectorsCut.Draw")
...
self:EmitSound("Fortnite_DirectorsCut.Swing_" .. math.random(1, 2) .. "")
self:MeleePickaxe()
end
...
if IsFirstTimePredicted() then
	...
	rocket.PickaxeType = "DirectorsCut"
	rocket:Activate()
...
self:StopSound("Fortnite_DirectorsCut.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_directorscut_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
