/*---------------------------------
FORTNITE AXERONI 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_axeroni.lua" )

SWEP.PrintName = "Axeroni"
...
SWEP.ViewModel = "models/fortnite/v_fbr_axeroni.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_axeroni.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_axeroni" )
killicon.Add( "fortnite_pickaxe_axeroni", "VGUI/hud/fortnite_pickaxe_axeroni", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_Axeroni.Draw_" .. math.random(1,2) .. "")
...
self:EmitSound("Fortnite_Axeroni.Swing_" .. math.random(1, 2) .. "")
self:MeleePickaxe()
end
...
self:StopSound("Fortnite_Axeroni.Draw_1")
self:StopSound("Fortnite_Axeroni.Draw_2")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_axeroni_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
