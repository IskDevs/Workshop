/*---------------------------------
FORTNITE GLOBAL AXE 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_globalaxe.lua" )

SWEP.PrintName = "Global Axe"
...
SWEP.ViewModel = "models/fortnite/v_fbr_globalaxe.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_globalaxe.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_globalaxe" )
killicon.Add( "fortnite_pickaxe_globalaxe", "VGUI/hud/fortnite_pickaxe_globalaxe", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_GlobalAxe.Draw")
...
self:EmitSound("Fortnite_GlobalAxe.Swing_" .. math.random(1, 2) .. "")
...
self:StopSound("Fortnite_GlobalAxe.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_globalaxe_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
