/*---------------------------------
FORTNITE DISCO BRAWL 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_disco.lua" )

SWEP.PrintName = "Disco Brawl"
...
SWEP.ViewModel = "models/fortnite/v_fbr_discobrawl.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_discobrawl.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_disco" )
killicon.Add( "fortnite_pickaxe_disco", "VGUI/hud/fortnite_pickaxe_disco", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_DiscoBrawl.Draw")
...
self:EmitSound("Fortnite_DiscoBrawl.Swing_" .. math.random(1, 3) .. "")
self:MeleePickaxe()
end
...
self:StopSound("Fortnite_DiscoBrawl.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_disco_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
