/*---------------------------------
FORTNITE PICKAXE 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe.lua" )
...
SWEP.ViewModel = "models/fortnite/v_fbr_pickaxe.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_pickaxe.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe" )
killicon.Add( "fortnite_pickaxe", "VGUI/hud/fortnite_pickaxe", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_Pickaxe.Draw")
	return true
end
...
self:EmitSound("Fortnite_Pickaxe.Swing_" .. math.random(1, 3) .. "")
...
self:StopSound("Fortnite_Pickaxe.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
