/*---------------------------------
FORTNITE PARTY ANIMAL 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_partyanimal.lua" )

SWEP.PrintName = "Party Animal"
...
SWEP.ViewModel = "models/fortnite/v_fbr_partyanimal.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_partyanimal.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_partyanimal" )
killicon.Add( "fortnite_pickaxe_partyanimal", "VGUI/hud/fortnite_pickaxe_partyanimal", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_PartyAnimal.Draw")
...
self:EmitSound("Fortnite_PartyAnimal.Swing_" .. math.random(1, 2) .. "")
self:MeleePickaxe()
end
...
if IsFirstTimePredicted() then
	...
	rocket.PickaxeType = "PartyAnimal"
	rocket:Activate()
...
self:StopSound("Fortnite_PartyAnimal.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_partyanimal_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
