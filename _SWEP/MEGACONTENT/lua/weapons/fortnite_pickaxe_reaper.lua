/*---------------------------------
FORTNITE REAPER 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_reaper.lua" )

SWEP.PrintName = "Reaper"
...
SWEP.ViewModel = "models/fortnite/v_fbr_reaper.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_reaper.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_reaper" )
killicon.Add( "fortnite_pickaxe_reaper", "VGUI/hud/fortnite_pickaxe_reaper", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_Reaper.Draw")
...
self:EmitSound("Fortnite_Reaper.Swing_" .. math.random(1, 2) .. "")
self:MeleePickaxe()
end
...
self:StopSound("Fortnite_Reaper.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_reaper_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
