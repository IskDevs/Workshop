/*---------------------------------
FORTNITE AXERCISE 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_axercise.lua" )

SWEP.PrintName = "Axercise"
...
SWEP.ViewModel = "models/fortnite/v_fbr_axercise.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_axercise.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_axercise" )
killicon.Add( "fortnite_pickaxe_axercise", "VGUI/hud/fortnite_pickaxe_axercise", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_Axercise.Draw")
...
self:EmitSound("Fortnite_Axercise.Swing_" .. math.random(1, 2) .. "")
self:MeleePickaxe()
end
...
self:StopSound("Fortnite_Axercise.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_axercise_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
