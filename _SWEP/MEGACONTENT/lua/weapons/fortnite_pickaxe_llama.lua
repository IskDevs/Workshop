/*---------------------------------
FORTNITE CHOCO LLAMA 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_llama.lua" )

SWEP.PrintName = "Chocollama"
...
SWEP.ViewModel = "models/fortnite/v_fbr_chocollama.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_chocollama.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_llama" )
killicon.Add( "fortnite_pickaxe_llama", "VGUI/hud/fortnite_pickaxe_llama", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_ChocoLlama.Draw")
...
self:EmitSound("Fortnite_ChocoLlama.Swing_" .. math.random(1, 3) .. "")
self:MeleePickaxe()
end
...
self:StopSound("Fortnite_ChocoLlama.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_llama_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
