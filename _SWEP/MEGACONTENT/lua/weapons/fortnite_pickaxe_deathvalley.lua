/*---------------------------------
FORTNITE DEATH VALLEY 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_deathvalley.lua" )

SWEP.PrintName = "Death Valley"
...
SWEP.ViewModel = "models/fortnite/v_fbr_deathvalley.mdl" 
SWEP.WorldModel = "models/fortnite/w_fbr_deathvalley.mdl"
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_deathvalley" )
killicon.Add( "fortnite_pickaxe_deathvalley", "VGUI/hud/fortnite_pickaxe_deathvalley", color_white )
end
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_DeathValley.Draw")
...
self:EmitSound("Fortnite_DeathValley.Swing_" .. math.random(1, 2) .. "")
self:MeleePickaxe()
end
...
if IsFirstTimePredicted() then
	...
	rocket.PickaxeType = "DeathValley"
	rocket:Activate()
...
self:StopSound("Fortnite_DeathValley.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_deathvalley_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
