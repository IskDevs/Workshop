...
FORK KNIFE 2019
---------------------------------*/
AddCSLuaFile( "fortnite_pickaxe_forkknife.lua" )

SWEP.PrintName = "Fork Knife"
...
SWEP.ViewModel = "models/fortnite/v_fbr_forkknife.mdl" 
...
if (CLIENT) then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/entities/fortnite_pickaxe_forkknife" )
killicon.Add( "fortnite_pickaxe_forkknife", "VGUI/hud/fortnite_pickaxe_forkknife", color_white )
end

SWEP.WElements = {
	["pickaxe_knife"] = { type = "Model", model = "models/fortnite/w_fbr_knife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["pickaxe_fork"] = { type = "Model", model = "models/fortnite/w_fbr_fork.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.596, 1.557, 0.518), angle = Angle(36.234, 155.455, 19.87), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	...
	self:EmitSound("Fortnite_ForkKnife.Draw")
...
self:EmitSound("Fortnite_ForkKnife.Swing_" .. math.random(1, 2) .. "")
self:MeleePickaxe()
end
...
self:StopSound("Fortnite_ForkKnife.Draw")
end
...
timer.Simple( 1, function() if IsValid(self) and IsValid(self.Owner) then self.Owner:Give("fortnite_pickaxe_forkknife_swep_ai") SafeRemoveEntity(self) end end )
end
return true
end
