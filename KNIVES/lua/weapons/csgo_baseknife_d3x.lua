...
if ( SERVER ) then
  ...
  CreateConVar("csgo_knives_dmg_sec_back", 10, FCVAR_ARCHIVE, "How much damage deal when hit with secondary attack from behind")
  CreateConVar("csgo_knives_dmg_sec_front", 10, FCVAR_ARCHIVE, "How much damage deal when hit with secondary attack in front or from side")
  CreateConVar("csgo_knives_dmg_prim_back", 10, FCVAR_ARCHIVE, "How much damage deal when hit with primary attack from behind")
  CreateConVar("csgo_knives_dmg_prim_front1", 10, FCVAR_ARCHIVE, "How much damage deal when firstly hit with primary attack in front or from side")
  CreateConVar("csgo_knives_dmg_prim_front2", 10, FCVAR_ARCHIVE, "How much damage deal when subsequently hit with primary attack in front or from side")
end
...
function SWEP:Think()
  ...
  if CurTime()>=self:GetIdleTime() then
    ...
    self:SetIdleTime( CurTime() + (IsValid(self.Owner:GetViewModel()) and self.Owner:GetViewModel():SequenceDuration() or 0) )
  end
end
